...
@Component(
	immediate = true,
			property = {
				...
				"javax.portlet.display-name=Portlet One",
				"javax.portlet.name=portlet-one",
				"javax.portlet.security-role-ref=power-user,user"
			},
	service = Portlet.class
)
public class PortletOne implements Portlet {
	...
	public void render(RenderRequest request, RenderResponse response) throws PortletException, IOException {
		...
		printWriter.print("<h1>Portlet One<h1><p>Date: " + String.valueOf(new Date()) + "</p>");		
